...
export default async function CustomerPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const action = reviewKyc.bind(null, customer.id);
  return <div className="space-y-4">
    <PageHeader title={customer.fullName} description={`${customer.customerNumber} · ${customer.phone ?? "No phone"}`}><StatusBadge status={customer.kycStatus} /></PageHeader>
