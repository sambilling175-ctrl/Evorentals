...
| D10-01 | P0 | Establish company-scoped receivables ledger for invoices, payments, allocations, deposits, refunds, and dues | In progress | Codex / `agent/d10-01-receivables-ledger`; migrations applied and advisors verified; typed live workspace implemented; validate passed; posting forms/actions and preview smoke test pending | D9-05, payment settings | Collections, Finance |
