...
| D10-01 | P0 | Establish company-scoped receivables ledger for invoices, payments, allocations, deposits, refunds, and dues | In progress | Codex / `agent/d10-01-receivables-ledger`; migrations `20260810160000` and `20260810160100` applied; RLS/grants/invoker functions/zero rows/advisors verified; typed service and UI pending | D9-05, payment settings | Collections, Finance |
