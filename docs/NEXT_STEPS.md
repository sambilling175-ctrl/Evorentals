...
| D4-04 | P1 | Add auth recovery and protected-route Playwright coverage | Review | Codex / `agent/d4-04-auth-coverage`; Playwright protected-route, public recovery, invalid-token, and fallback-fragment coverage passes locally; real mail journey remains gated | Stable SMTP/test mailbox for the final real recovery journey | Auth, tests |
...
| D12-01 | P0 | Review and integrate the D10-01 receivables prerequisite | Completed | Codex / `agent/d12-01-settlement-integration`; dependency order corrected; PR #10 merged as `f361396`; Vercel status successful; live schema/advisors and `npm.cmd run validate` verified | D9-05 | Collections, release |
| D12-02 | P0 | Review and integrate D9-06 rental settlement | Ready | Unassigned | D12-01 | Rentals, release |
