...
| D9-06 | P0 | Finalize returned rentals with immutable settlement snapshots and atomic closure | In progress | Codex / `agent/d9-06-rental-settlement`; started 2026-08-10; migration owner: yes; schema verified; settlement ledger, RPC, typed service/action/UI pending | D9-05 | Rentals, Collections |
