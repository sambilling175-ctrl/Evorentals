...
| D10-01 | P0 | Establish company-scoped receivables ledger for invoices, payments, allocations, deposits, refunds, and dues | In progress | Codex / `agent/d10-01-receivables-ledger`; started 2026-08-10; migration owner: yes; live absence verified; schema/RPC/service/UI pending | D9-05, payment settings | Collections, Finance |
