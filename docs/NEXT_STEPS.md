...
| D10-03 | P0 | Record returned-rental collections with damage allocations and immutable receipt history | Review | Codex / `agent/d12-03-returned-rental-collections`; migrations `20260814060344` and `20260814073417` are live and cleanly integrated; current release validation/preview pending | D9-05, D10-01 | Collections, settlement |
