...
| D13-07 | P1 | Add service dashboard metrics, turnaround time, overdue jobs, and readiness | Ready | Next implementation after D13-06 review; use live job-card events and fleet state without introducing demo records | D13-06 | Service, reporting |
