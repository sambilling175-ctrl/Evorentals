...
| D9-06 | P0 | Finalize returned rentals with immutable settlement snapshots and atomic closure | In progress | Codex / `agent/d9-06-rental-settlement`; D10-01 ledger merged locally; live schema verified; implementing atomic settlement RPC, immutable snapshot, typed action, and UI | D9-05, D10-01 | Rentals, Collections |
