...
| D10-03 | P0 | Record returned-rental collections with damage allocations and immutable receipt history | Review | Codex / `agent/d12-03-returned-rental-collections`; live migrations `20260814060344`, `20260814073417`, `20260821060601`, and `20260821060716`; validate and advisor checks pass; preview release pending | D9-05, D10-01 | Collections, settlement |
| D12-03 | P0 | Review and integrate D10-03 returned-rental collections | Review | Codex / `agent/d12-03-returned-rental-collections`; clean integration, H1 RLS, payment refresh guard, FK-index hardening, validation, and live checks complete; push/PR/preview pending | D9-06, D10-01 | Collections, release |
