...
| D13-07 | P1 | Add service dashboard metrics, turnaround time, overdue jobs, and readiness | Review | Codex / `agent/d13-07-service-dashboard`; typed live stage counts, SLA-based overdue jobs, average turnaround, and deployment readiness; `npm.cmd run validate` passed; live service job-card count remains zero; no migration or business records | D13-06 | Service, reporting |
