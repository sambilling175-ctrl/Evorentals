...
| D9-04 | P0 | Swap vehicles on open rentals with odometer reconciliation and immutable history | Review | Codex / `agent/d9-04-vehicle-swaps`; validate and live schema/security verification passed; production release pending | D9-03 | Rentals, Fleet, Bookings |
