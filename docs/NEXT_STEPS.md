...
| D13-06 | P1 | Atomically update fleet availability when service begins or finishes | Ready | Next implementation after D13-05 review; requires a live-schema check for bike status/availability invariants and a new invoker transition seam; no records should be created | D13-05, D7-01 | Service, fleet |
