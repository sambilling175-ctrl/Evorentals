...
| D4-06 | P1 | Configure production custom SMTP and branded Auth templates | In progress | Codex / `agent/d4-06-resend-smtp`; Resend test sender and Supabase template handoff in progress | User must enter the Resend API key in Supabase Auth SMTP, then complete one mailbox smoke test | Supabase Auth |
