...
| D12-06 | P1 | Add CI validation, Playwright route tests, migration checks, and SQL tests | Ready | Route test foundation is now available from D12-04; no CI workflow exists yet | D12-04, D12-05 | CI, tests |
