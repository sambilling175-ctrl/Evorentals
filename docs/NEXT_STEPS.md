...
| D10-02 | P1 | Replace reports placeholder with live operational summaries and CSV export | In progress | Codex / `agent/d10-02-live-reports-clean`; clean integration started automatically after D12-03 release handoff; migration owner: no | D9-06, D10-01 | Reports, dashboard |
