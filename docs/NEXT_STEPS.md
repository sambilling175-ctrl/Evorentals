...
| D13-02 | P1 | Add service job cards and controlled status transitions | Review | Codex / `agent/d13-02-service-job-cards`; five live migrations (`20260821143147`, `20260821143345`, `20260821144218`, `20260821144303`, `20260821144335`); company-scoped RLS, invoker RPCs, immutable event history, actor guard, local validate/checks passed, 11-route Playwright passed; stacked on D13-01 draft PR #20; no job-card records | D13-01 | Service, maintenance |
