...
| D10-03 | P0 | Record returned-rental collections with damage allocations and immutable receipt/audit history | Review | Codex / `agent/d10-03-returned-rental-collections`; migration `20260814055140_returned_rental_collections.sql` pending application; `npm.cmd run validate` passed; live database/advisor and authenticated form smoke pending | D9-05, D10-01 | Collections, settlement |
