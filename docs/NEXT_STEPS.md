...
| D13-08 | P1 | Verify service RLS/history/advisors and add rollback-only SQL tests | Ready | Next after D13-07 review; confirm company isolation, immutable history, fixed search paths, grants, and service dashboard query contracts | D13-07 | Service, security, tests |
