...
| D11-03 | P1 | Dry-run and import conflict-free legacy customer metadata | In progress | Codex / `agent/d11-03-customer-import-next`; guarded import RPC and migrations present; local plan gate is being validated; authenticated administrator remote dry-run/apply remains required; no customer rows or KYC binaries will be written by this task without explicit confirmation | D11-02 | Migration, customers |
