...
| D13-01 | P1 | Add company-scoped service reasons and service request intake | In progress | Codex / `agent/d13-01-service-requests`; migration `20260821141140_d13_01_service_requests` applied; 8 controlled reasons seeded, 0 service requests; typed service/action/UI implemented; validation and advisors pending final handoff | D12 release | Service, maintenance |
