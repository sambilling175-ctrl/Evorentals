...
| D10-03 | P0 | Record returned-rental collections with damage allocations and immutable receipt/audit history | Review | Codex / `agent/d10-03-returned-rental-collections`; commits `1621c72`, `45be7f1`; migration applied as live version `20260814060344`; invoker/RLS/grants/triggers verified; advisors show only pre-existing findings; READY preview has no `/payments` runtime errors; authenticated form smoke pending | D9-05, D10-01 | Collections, settlement |
